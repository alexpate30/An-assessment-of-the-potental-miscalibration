...
ggsave("figures/MSM2017/male.calibration.unweighted.validation.png", calibration.unweighted, dpi = 600)
ggsave("figures/MSM2017/male.calibration.unweighted.timeadj.validation.png", calibration.unweighted.timeadj, dpi = 600)

male.calibration.validation.nonMSM <- ggarrange(calibration.unweighted, calibration.unweighted.timeadj, 
                                                  nrow = 1, ncol = 2,
                                                  common.legend = TRUE, legend = "bottom")
ggsave("figures/MSM2017/male.calibration.validation.nonMSM.png", male.calibration.validation.nonMSM, 
...
save.image("R_out_MSM2017/male_analysis_calibration_validation_nonMSM.RData")
print("saved")
...
load("R_out_MSM2017/derive_outcome_variables1_male.RData")
res_comb1 <- do.call("rbind",res_comb)
load("R_out_MSM2017/derive_outcome_variables2_male.RData")
res_comb2 <- do.call("rbind",res_comb)
load("R_out_MSM2017/derive_outcome_variables3_male.RData")
res_comb3 <- do.call("rbind",res_comb)
load("R_out_MSM2017/derive_outcome_variables4_male.RData")
res_comb4 <- do.call("rbind",res_comb)
load("R_out_MSM2017/derive_outcome_variables5_male.RData")
res_comb5 <- do.call("rbind",res_comb)
load("R_out_MSM2017/derive_outcome_variables6_male.RData")
res_comb6 <- do.call("rbind",res_comb)
load("R_out_MSM2017/derive_outcome_variables7_male.RData")
res_comb7 <- do.call("rbind",res_comb)
load("R_out_MSM2017/derive_outcome_variables8_male.RData")
res_comb8 <- do.call("rbind",res_comb)
load("R_out_MSM2017/derive_outcome_variables9_male.RData")
res_comb9 <- do.call("rbind",res_comb)
load("R_out_MSM2017/derive_outcome_variables10_male.RData")
...
data_T1 <- read.table("data/CSV2017/analysis_dataset_male_T1.csv",header=TRUE, sep = ",")
data_T2 <- read.table("data/CSV2017/analysis_dataset_male_T2.csv",header=TRUE, sep = ",")
data_T3 <- read.table("data/CSV2017/analysis_dataset_male_T3.csv",header=TRUE, sep = ",")
data_T4 <- read.table("data/CSV2017/analysis_dataset_male_T4.csv",header=TRUE, sep = ",")
data_T5 <- read.table("data/CSV2017/analysis_dataset_male_T5.csv",header=TRUE, sep = ",")
data_T6 <- read.table("data/CSV2017/analysis_dataset_male_T6.csv",header=TRUE, sep = ",")
data_T7 <- read.table("data/CSV2017/analysis_dataset_male_T7.csv",header=TRUE, sep = ",")
data_T8 <- read.table("data/CSV2017/analysis_dataset_male_T8.csv",header=TRUE, sep = ",")
data_T9 <- read.table("data/CSV2017/analysis_dataset_male_T9.csv",header=TRUE, sep = ",")
...
## Start by doing LOCF and NOCF, this will impute all the different time points as long ##
...
data_anal_predictor_imp <- data_anal_predictor %>%
  ...
  fill(BMI_tv, Cholesterol_HDL_Ratio_tv, CKD345_tv, SBP_tv, SBP_var_tv, Smoking_tv) %>%
  # Then do next observation carried backwards, for any that have no non-missing observations before it
  fill(BMI_tv, Cholesterol_HDL_Ratio_tv, CKD345_tv, SBP_tv, SBP_var_tv, Smoking_tv, .direction = "up") %>%
  ungroup() %>%
  as.data.frame()
...
save.image("R_out_MSM2017/derive_analysis_dataset_male_p1.RData")
print("image saved")

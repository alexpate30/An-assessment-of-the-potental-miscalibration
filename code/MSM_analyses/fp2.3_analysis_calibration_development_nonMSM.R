...
create_risks<-function(data.in){
  ...
  S<-model.matrix(Surv(patid,rep(0,nrow(data.in)), type='right') ~ Ethnicity_T0 + Townsend_T0 + agefrac1_T0 + BMIfrac1_T0 + BMIfrac2_T0 + 
...
ggsave("figures/MSM2017/female.calibration.unweighted.development.png", calibration.unweighted, dpi = 600)
ggsave("figures/MSM2017/female.calibration.unweighted.timeadj.development.png", calibration.unweighted.timeadj, dpi = 600)

female.calibration.development.nonMSM <- ggarrange(calibration.unweighted, calibration.unweighted.timeadj, 
                                                  nrow = 1, ncol = 2,
                                                  common.legend = TRUE, legend = "bottom")
ggsave("figures/MSM2017/female.calibration.development.nonMSM.png", female.calibration.development.nonMSM, 
...
save.image("R_out_MSM2017/female_analysis_calibration_development_nonMSM.RData")
print("saved")
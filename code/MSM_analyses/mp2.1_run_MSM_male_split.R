...
load("R_out_MSM2017/derive_analysis_dataset_male_p3.RData")
...
data_anal$c.timefrac1_T0 <- log((data_anal$c.time_T0+1)/1000)
data_anal$c.timefrac2_T0 <- ((data_anal$c.time_T0+1)/1000)^0.5
data_anal$agefrac1_T0 <- (data_anal$age_T0/100)^-1
data_anal$agefrac2_T0 <- (data_anal$age_T0/100)^3
data_anal$BMIfrac1_T0 <- (data_anal$BMI_T0/10)
data_anal$SBPfrac1_T0 <- (data_anal$SBP_T0/100)^3
data_anal$SBPfrac2_T0 <- ((data_anal$SBP_T0/100)^3)*log(data_anal$SBP_T0/100)
...
data_anal$BMIfrac1_tv <- (data_anal$BMI_tv/10)
data_anal$SBPfrac1_tv <- (data_anal$SBP_tv/100)^3
data_anal$SBPfrac2_tv <- ((data_anal$SBP_tv/100)^3)*log(data_anal$SBP_tv/100)
...
weights.obj <- ipwtm(exposure = stat_end365, family = "survival", 
                     numerator = ~ Ethnicity_T0 + Townsend_T0 + agefrac1_T0 + agefrac2_T0 + BMIfrac1_T0 + 
                     SBPfrac1_T0 + SBPfrac2_T0 + Atrialfib_T0 + Atypical_antipsy_med_T0 + Cholesterol_HDL_Ratio_T0 + CKD345_T0 + 
                       ...
                       Smoking_T0 + SLE_T0, 
                     denominator = ~ Ethnicity_T0 + Townsend_T0 + agefrac1_T0 + agefrac2_T0 + BMIfrac1_T0 + 
                       SBPfrac1_T0 + SBPfrac2_T0 + Atrialfib_T0 + Atypical_antipsy_med_T0 + Cholesterol_HDL_Ratio_T0 + CKD345_T0 + 
                       Corticosteroid_use_T0 + T1dia_T0 + T2dia_T0 + Erec_dysfunc_T0 + FamHis_T0 + HIV_T0 + Hypertension_T0 + Migraine_T0 + RA_T0 + Sev_men_ill_qrisk_T0 + SBP_var_T0 +
                       Smoking_T0 + SLE_T0 +
                       Atrialfib_tv + BMIfrac1_tv + SBPfrac1_tv + SBPfrac2_tv + CKD345_tv + Hypertension_tv + RA_tv + Smoking_tv, 
...
print("cox model 1")
Sys.time()
unweighted.cox.model <- coxph(Surv(tstart, tend, event) ~ Ethnicity_T0 + Townsend_T0 + agefrac1_T0 + agefrac2_T0 + BMIfrac1_T0 +
                                SBPfrac1_T0 + SBPfrac2_T0 + Atrialfib_T0 + Atypical_antipsy_med_T0 + Cholesterol_HDL_Ratio_T0 + CKD345_T0 + 
                                Corticosteroid_use_T0 + T1dia_T0 + T2dia_T0 + Erec_dysfunc_T0 + FamHis_T0 + HIV_T0 + Hypertension_T0 + Migraine_T0 + RA_T0 + Sev_men_ill_qrisk_T0 + SBP_var_T0 +
...
print("cox model 2")
Sys.time()
unweighted.cox.model.timeadj <- coxph(Surv(tstart, tend, event) ~ Ethnicity_T0 + Townsend_T0 + agefrac1_T0 + agefrac2_T0 + BMIfrac1_T0 +
                                        SBPfrac1_T0 + SBPfrac2_T0 + Atrialfib_T0 + Atypical_antipsy_med_T0 + Cholesterol_HDL_Ratio_T0 + CKD345_T0 + 
                                        Corticosteroid_use_T0 + T1dia_T0 + T2dia_T0 + Erec_dysfunc_T0 + FamHis_T0 + HIV_T0 + Hypertension_T0 + Migraine_T0 + RA_T0 + Sev_men_ill_qrisk_T0 + SBP_var_T0 +
...
print("cox model 3")
Sys.time()
weighted.cox.model <- coxph(Surv(tstart, tend, event) ~ stat_start365 + Ethnicity_T0 + Townsend_T0 + agefrac1_T0 + agefrac2_T0 + BMIfrac1_T0 +
                              SBPfrac1_T0 + SBPfrac2_T0 + Atrialfib_T0 + Atypical_antipsy_med_T0 + Cholesterol_HDL_Ratio_T0 + CKD345_T0 + 
                              Corticosteroid_use_T0 + T1dia_T0 + T2dia_T0 + Erec_dysfunc_T0 + FamHis_T0 + HIV_T0 + Hypertension_T0 + Migraine_T0 + RA_T0 + Sev_men_ill_qrisk_T0 + SBP_var_T0 +
...
print("cox model 4")
Sys.time()
weighted.cox.model.timeadj <- coxph(Surv(tstart, tend, event) ~ stat_start365 + Ethnicity_T0 + Townsend_T0 + agefrac1_T0 + agefrac2_T0 + BMIfrac1_T0 +
                                      SBPfrac1_T0 + SBPfrac2_T0 + Atrialfib_T0 + Atypical_antipsy_med_T0 + Cholesterol_HDL_Ratio_T0 + CKD345_T0 + 
                                      Corticosteroid_use_T0 + T1dia_T0 + T2dia_T0 + Erec_dysfunc_T0 + FamHis_T0 + HIV_T0 + Hypertension_T0 + Migraine_T0 + RA_T0 + Sev_men_ill_qrisk_T0 + SBP_var_T0 +
...
save.image("R_out_MSM2017/run_MSM_male_split_fracpoly_V2.RData")
print("image saved")
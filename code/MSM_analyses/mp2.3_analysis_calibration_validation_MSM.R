...
ggsave("figures/MSM2017/male.calibration.weighted.validation.nostatcohort.png", calibration.weighted.nostat, dpi = 600)
ggsave("figures/MSM2017/male.calibration.weighted.timeadj.validation.nostatcohort.png", calibration.weighted.timeadj.nostat, dpi = 600) 

male.calibration.validation.MSM <- ggarrange(calibration.weighted.nostat, calibration.weighted.timeadj.nostat, 
                                               nrow = 1, ncol = 2,
                                               common.legend = TRUE, legend = "bottom")
ggsave("figures/MSM2017/male.calibration.validation.MSM.png", male.calibration.validation.MSM, 
...
save.image("R_out_MSM2017/male_analysis_calibration_validation_MSM.RData")
print("saved")
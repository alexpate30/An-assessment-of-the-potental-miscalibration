...
ggsave("figures/MSM2017/female.calibration.unweighted.validation.png", calibration.unweighted, dpi = 600)
ggsave("figures/MSM2017/female.calibration.unweighted.timeadj.validation.png", calibration.unweighted.timeadj, dpi = 600)


female.calibration.validation.nonMSM <- ggarrange(calibration.unweighted, calibration.unweighted.timeadj, 
                                                  nrow = 1, ncol = 2,
                                                  common.legend = TRUE, legend = "bottom")
ggsave("figures/MSM2017/female.calibration.validation.nonMSM.png", female.calibration.validation.nonMSM, 
...
save.image("R_out_MSM2017/female_analysis_calibration_validation_nonMSM.RData")
print("saved")
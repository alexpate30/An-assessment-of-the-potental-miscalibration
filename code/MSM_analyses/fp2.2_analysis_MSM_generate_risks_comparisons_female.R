...
ggsave("figures/MSM2017/female.calibration.unweighted.fracpoly_V2.png", calibration.unweighted, dpi = 600)
ggsave("figures/MSM2017/female.calibration.unweighted.timeadj.fracpoly_V2.png", calibration.unweighted.timeadj, dpi = 600)
ggsave("figures/MSM2017/female.calibration.weighted.fracpoly_V2.png", calibration.weighted, dpi = 600)
ggsave("figures/MSM2017/female.calibration.weighted.timeadj.fracpoly_V2.png", calibration.weighted.timeadj, dpi = 600) 

rm(data_devel, data_valid)
save.image("R_out_MSM2017/analysis_MSM_female_split_fracpoly_V2.RData")
print("saved")

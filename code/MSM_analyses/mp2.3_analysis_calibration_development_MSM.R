...
ggsave("figures/MSM2017/male.calibration.weighted.development.nostatcohort.png", calibration.weighted.nostat, dpi = 600)
ggsave("figures/MSM2017/male.calibration.weighted.timeadj.development.nostatcohort.png", calibration.weighted.timeadj.nostat, dpi = 600) 

male.calibration.development.MSM <- ggarrange(calibration.weighted.nostat, calibration.weighted.timeadj.nostat, 
                                             nrow = 1, ncol = 2,
                                             common.legend = TRUE, legend = "bottom")
ggsave("figures/MSM2017/male.calibration.development.MSM.png", male.calibration.development.MSM, 
...
save.image("R_out_MSM2017/male_analysis_calibration_development_MSM.RData")
print("saved")
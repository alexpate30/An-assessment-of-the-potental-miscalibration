...
## Not including cholesterol in this as not using in the MSM either, make sure it isn't used to predict anything,
## It shouldnt be predicted either, as I have removed it from the method state
...
save.image("R_out_MSM2017/impute_baseline_data_female.RData")
print("image saved")
